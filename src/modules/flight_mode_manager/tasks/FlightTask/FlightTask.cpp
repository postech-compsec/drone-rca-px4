...
const trajectory_setpoint_s FlightTask::empty_trajectory_setpoint = {0, 0, {NAN, NAN, NAN}, {NAN, NAN, NAN}, {NAN, NAN, NAN}, {NAN, NAN, NAN}, NAN, NAN, 0};
const vehicle_constraints_s FlightTask::empty_constraints = {0, 0, NAN, NAN, 0, false, {}};
const landing_gear_s FlightTask::empty_landing_gear_default_keep = {0, 0, 0, landing_gear_s::GEAR_KEEP, {}};
